...
<div class="tabs">
  ...
  <div id="explanatory" class="tab-content">
    <h2>Explanatory Content Examples</h2>
    <p>These guides showcase my ability to break down complex technical concepts.</p>
    
    <div class="portfolio-item">
      <h3>Robot Configuration Guide</h3>
      <p>Step-by-step instructions for configuring and deploying robots using the Viam platform.</p>
      <div class="pdf-container">
        <iframe src="/assets/pdfs/robot_configuration_guide.pdf" width="100%" height="500px"></iframe>
      </div>
    </div>
  </div>
  ...
  <div id="tutorials" class="tab-content">
    ...
    <div class="portfolio-item">
      <h3>Getting Started with Robotics Development</h3>
      <p>A beginner-friendly tutorial for new developers working with the Viam platform.</p>
      <div class="pdf-container">
        <iframe src="/assets/pdfs/getting_started_tutorial.pdf" width="100%" height="500px"></iframe>
      </div>
    </div>
  </div>
  ...
  <div id="technical-blogs" class="tab-content">
    ...
    <div class="portfolio-item">
      <h3>The Future of Robotics Development</h3>
      <p>An insightful analysis of emerging trends in robotics development and how they impact developers.</p>
      <div class="pdf-container">
        <iframe src="/assets/pdfs/robotics_future_blog.pdf" width="100%" height="500px"></iframe>
      </div>
    </div>
  </div>
</div>
